...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedStrings = {
    'en': {
      ...
      'authInvalidRequest': 'Invalid request. Please check your input.',
      ...
      'soundEffectsDesc': 'Play sound effects during the game',
      ...
      'deleteGameConfirmMessage':
          'This will permanently delete the game record. This action can\'t be undone.',
      'delete': 'Delete',
      'deleteGameFailed': 'Failed to delete. Please try again.',
      'deleteGameSuccess': 'Game deleted.',
    ...
    'zh': {
      ...
      'cancel': '取消',
      'networkError': '無法連接到伺服器，請檢查網路後再試。',
      'authEndpointNotFoundLogin': '找不到登入 API，請確認 API_BASE_URL 是否包含 /api。',
      'authEndpointNotFoundRegister': '找不到註冊 API，請確認 API_BASE_URL 是否包含 /api。',
      'authBadTokenResponse': '登入成功但 Token 回傳格式不正確。',
      'authBadUserResponse': '登入成功但用戶資料回傳格式不正確。',
      'authLoginFailed': '登入失敗，請稍後再試。',
      'authRegisterFailed': '註冊失敗，請稍後再試。',
      'authEmailExists': '此 Email 已被註冊。',
      'authInvalidCredentials': 'Email 或密碼不正確。',
      'authInvalidRequest': '請求參數驗證失敗，請檢查輸入。',
      ...
      'reducedMotionDesc': '減少動畫與轉場效果',
      'highContrast': '高對比',
      'highContrastDesc': '提升對比度以便閱讀',
      'english': '英文',
      ...
      'soundEffects': '音效',
      'soundEffectsDesc': '在遊戲中播放音效',
      'breathingDuration': '呼吸時長',
      'apiServer': '後端伺服器',
      ...
      'deleteGame': '刪除棋局',
      'deleteGameConfirmTitle': '確定要刪除棋局嗎？',
      'deleteGameConfirmMessage': '這會永久刪除該棋局紀錄，且無法復原。',
      'delete': '刪除',
      'deleteGameFailed': '刪除失敗，請稍後再試。',
      'deleteGameSuccess': '已刪除棋局。',
      'gameCompleted': '遊戲完成',
      'gameAbandoned': '遊戲中止',
